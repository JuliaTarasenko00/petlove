      ...
      <div className="w-[100%] ">
        <div className=" relative ">
          <input
            ...
            className={`w-[100%] rounded-[30px] ${disabled && 'cursor-no-drop'} border-[1px]  ${activeBorder ? 'border-[#f6b83d]' : 'border-[#26262626]'} bg-transparent ${errorMessage && 'border-[2px] border-[#ef2447]'} 'outline-none' p-[10px] text-[#262626] outline-offset-0`}
          />
        </div>
        {errorMessage ? (
